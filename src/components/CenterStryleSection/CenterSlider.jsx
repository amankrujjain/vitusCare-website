...
import CenterStyle3 from '../CenterStryleSection/CenterStyle3'; // Import the individual center component

export default function CenterSlider({ data }) {
  /** Slider Settings **/
  ...
  return (
    ...
    >
      {data?.map((item, index) => (
        <div key={index}>
          <CenterStyle3 {...item} /> {/* Pass individual center data */}
        </div>
      ))}
    </Slider>
  );
