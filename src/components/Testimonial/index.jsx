      ...
      <div className="cs_tab_body">
        {activeTab === 1 && (
          <div className="cs_testimonial cs_style_1">
            ...
            <p>
              I recently had to bring my child to VitusCare for a minor injury,
        ...
        {activeTab === 2 && (
          <div className="cs_testimonial cs_style_1">
            ...
            <p>
              ...
              my child to VitusCare for a minor injury, and I was so impressed
        ...
        {activeTab === 3 && (
          <div className="cs_testimonial cs_style_1">
            ...
            <p>
              ...
              kind and attentive I recently had to bring my child to VitusCare
